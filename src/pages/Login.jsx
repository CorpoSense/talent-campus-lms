...
export const Login = () => {
  ...
  return (
    <><Navbar /><div className="flex text-lato sm:flex-row flex-col-reverse py-5 w-[90%] justify-center items-center sm:justify-between min-h-[100vh] mx-auto sm:h-[80vh]">
      <form
