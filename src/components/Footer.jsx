...
export const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-[#A8DFF5] via-[#F8D7C4] via-[#F2F1E0] to-white py-8 font-['Lato']">
  ...
  <ul className=" flex flex-col  space-y-4 text-[#343A40]">
    ...
    <li className="text-[16px] ">Praesent nulla massa, hendrerit vestibulum <br/>gravida in, feugiat auctor felis.</li>
               ...
               <button className="w-[40px] h-[40px] rounded-full bg-white flex items-center justify-center">
                ...
                <button className="w-[40px] h-[40px] rounded-full bg-white flex items-center justify-center">
                 <a href="https://www.linkedin.com">
                    <img src={linkedin} className='w-[18] h-[18px]'alt="linkedin"/>
                 </a>
                </button>

                <button className="w-[40px] h-[40px] rounded-full bg-white flex items-center justify-center">
                 <a href="https://www.instagram.com">
                    <img src={insta} className='w-[18] h-[18px]'alt="insta"/>
                 </a>
                </button>

                <button className="w-[40px] h-[40px] rounded-full bg-white flex items-center justify-center">
                 <a href="https://www.behance.net/">
                    <img src={Behance} className='w-[18] h-[18px]'alt="Behance"/>
                 </a>
                </button>
           </div>
  </div>
 ...
 <div className="flex items-center">
  ...
  <ul className=" flex flex-col items-center space-y-4 text-[#343A40]">
    ...
    <li className="text-[16px] "><a href="#about" className="hover:text-[#ffc107]">Home</a></li>
    <li className="text-[16px] "><a href="#courses" className="hover:text-[#ffc107]">Courses</a></li>
    <li className="text-[16px] "><a href="#contact" className="hover:text-[#ffc107]">Contact</a></li>
  </ul>
  </div>
  </div>
