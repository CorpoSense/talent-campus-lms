...
import curvedLine from "../../public/curvedLine.svg";
...
export const Hero=()=>
    {
        return (
        <div className="w-[90%] mx-auto  remaining-height-element items-center justify-center  flex flex-col  space-y-5">
          <div className="md:w-[800px] w-[500px] top-[67px]  right-0 absolute bgHome remaining-height-element ">
          </div>
          <img src={hat} className="absolute xxs:w-[100px] xxs:top-[15%] w-[50px] top-[17%] right-[10%] lg:right-[30%] md:right-[20%]" ></img>
   ...
   <h1 className="sm:text-5xl text-4xl z-20 leading-[50px] sm:leading-[70px] font-bold text-center" > <span className=" bg-gradient-to-r from-[#007bff] to-[rgb(32,180,134)]    inline-block text-transparent bg-clip-text ">
