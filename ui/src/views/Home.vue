    ...
    <main>
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-6">
              ...
              <b-button variant="outline-success" size="lg" class="mb-2" @click="getCourses">Get Started</b-button>
            </div>
            <div class="col-lg-6">
              <img src="/hero-image.jpeg" alt="Students learning" class="img-fluid rounded">
            </div>
          </div>
        </div>
      </section>
              ...
              <div class="card bg-light text-dark h-100">
                <div class="card-body">
                  ...
                  <footer class="blockquote-footer mt-3">
                    {{ testimonial.author }}
                    <cite title="Source Title">{{ testimonial.role }}</cite>
                  </footer>
                </div>
              </div>
            </div>
      ...
      <section class="py-5">
        <div class="container text-center">
          ...
          <b-button href="/courses" variant="primary" size="lg">Explore Courses</b-button>
        </div>
      </section>
    </main>
...
.hero {
  background: linear-gradient(45deg, #bebfc0, #6610f2);
}
