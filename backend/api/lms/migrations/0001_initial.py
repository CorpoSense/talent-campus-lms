    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('questionType', models.CharField(choices=[(lms.models.questionType['MULTIPLECHOICES'], 'multiple choices'), (lms.models.questionType['QA'], 'qa')], max_length=50)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.ManyToManyField(related_name='qa_question', to='lms.question')),
            ],
        ),
        migrations.CreateModel(
            name='QuestionChoice',
            fields=[
                ...
                ('question', models.ManyToManyField(related_name='question_choices', to='lms.question')),
            ],
        ),
        migrations.CreateModel(
            name='Quiz',
            fields=[
                ...
                ('createdBy', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='myQuestions', to='authApi.instructor')),
            ],
        ),
        migrations.AddField(
            model_name='question',
            name='quiz',
            field=models.ManyToManyField(related_name='questions', to='lms.quiz'),
        ),
        migrations.CreateModel(
            name='Recommendation',
            fields=[
                ...
                ('employee', models.ManyToManyField(blank=True, null=True, related_name='my_recommendations', to='authApi.employee')),
                ('student', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='my_recommendations', to='authApi.student')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enrollement', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='user_progresses', to='lms.enrollement')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='quiz_submissions', to='authApi.user')),
            ],
        ),
        migrations.CreateModel(
            name='Video',
