...
from .views import RegisterUserView,LoginUserView,CustomPasswordResetView,customResetPasswordDone,customPasswordResetConfirm,customPasswordResetCompleteView
urlpatterns = [
