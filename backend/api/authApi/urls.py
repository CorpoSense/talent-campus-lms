...
from .views import RegisterUserView,LoginUserView,CustomPasswordResetView,customResetPasswordDone,customPasswordResetConfirm,customPasswordResetCompleteView,ProfileView,TestView
urlpatterns = [
